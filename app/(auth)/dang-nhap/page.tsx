		...
		<main className="flex min-h-svh items-center justify-center bg-mesh-blue p-4 md:p-6 lg:p-8 relative overflow-hidden">
			...
			<div className="relative z-10 flex w-full max-w-[1400px] gap-4 md:gap-6 shadow-2xl rounded-[2.5rem] bg-card p-2 border border-border/40 overflow-hidden">
				...
				<div className="relative hidden w-1/2 flex-col justify-end gap-10 rounded-[2rem] overflow-hidden p-10 md:flex min-h-[750px] lg:min-h-[850px] [perspective:1200px]">
					...
					<div className="absolute inset-0 z-0">
						<Image
							...
							alt="Gaming Setup"
							fill
							className="object-cover brightness-[0.7] contrast-[1.1] transition-transform duration-[2000ms] hover:scale-105"
							priority
						/>
					...
					<FloatingGlassBlock className="top-20 left-20 opacity-70" size="lg" delay={0} rotate={10} moveRange={30}>
                        <Monitor className="w-12 h-12 text-white/80 drop-shadow-lg" strokeWidth={1.5} />
                    </FloatingGlassBlock>

					<FloatingGlassBlock className="top-1/3 right-15 opacity-50" size="md" delay={1.5} duration={7} rotate={15} moveRange={25}>
                        <Cpu className="w-8 h-8 text-white/80 drop-shadow-lg" strokeWidth={1.5} />
                    </FloatingGlassBlock>
                    
					<FloatingGlassBlock className="bottom-40 right-1/4 opacity-40" size="md" delay={2} duration={8} rotate={-15} moveRange={20}>
                        <Gamepad2 className="w-10 h-10 text-white/80 drop-shadow-lg" strokeWidth={1.5} />
                    </FloatingGlassBlock>
				...
				<div className="flex w-full flex-col justify-center rounded-[2.5rem] md:w-1/2 p-8 md:p-10 lg:px-20 lg:py-14 overflow-y-auto min-h-[750px] lg:min-h-[850px]">
					...
					{/* Form Section */}
					<div className="mx-auto w-full max-w-[420px] space-y-10 animate-in fade-in slide-in-from-right-8 duration-700">
