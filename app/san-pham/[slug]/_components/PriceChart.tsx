    ...
    aiChatService
      ...
      .then(({ past, future, note }) => {
        ...
        if (pastPoints.length > 0 && futurePoints.length > 0) {
          pastPoints[pastPoints.length - 1].future = pastPoints[pastPoints.length - 1].past
        }
    ...
    return (
      <Card className="border-border/50 mt-8">
        <CardHeader className="pb-2">
          ...
          <CardDescription className="text-xs">Đang tải dữ liệu dự đoán từ AI...</CardDescription>
        </CardHeader>
              ...
              content={
                <ChartTooltipContent
                  ...
                  formatter={(value, name) => [
                    ...
                    name === "past" ? "Giá thực tế" : "Dự đoán AI",
                  ]}
                />
              }
            />
